...
### 6. Улучшение DConf backend
- [ ] Внедрить `zvariant` для чтения бинарных dconf баз данных
  - Проблема: txt файлы содержат не все параметры
  - Решение: прямое чтение `~/.config/dconf/user` (GVariant формат)
  - Библиотека: https://crates.io/crates/zvariant
  - Преимущества: полный доступ ко всем настройкам без зависимости от txt файлов

### 7. Документация
- [ ] Описать использование библиотеки (rustdoc)
- [ ] Привести примеры кода

### 8. Дополнительные сервисы (будущее)
